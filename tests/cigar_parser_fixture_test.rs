...
fn test_cigar_parser_snapshot_fixture() {
    ...
    let fixture_path = manifest_dir.join("tests/fixtures/cigar_parser_chr20_168600_168800.jsonl");
    ...
    let temp_name = format!(
        "vardict_cigar_parser_snapshot_{}_{}.jsonl",
        std::process::id(),
        SystemTime::now()
    ...
    assert_eq!(actual, expected, "CigarParser snapshot mismatch");
}
